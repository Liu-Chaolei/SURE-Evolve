...
You are scoring one survey-cited paper keynote for research idea.
...
You are compressing one survey-cited paper keynote for research idea.
...
You are summarizing the lower-priority survey-cited paper keynotes for research idea.
