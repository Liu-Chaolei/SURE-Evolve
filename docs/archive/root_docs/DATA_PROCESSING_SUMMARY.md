...
> Current task metric entrypoints live under `src/sure_eval/evaluation/tasks/<task>/`.
...
| 文件 | 说明 |
|------|------|
| `src/sure_eval/evaluation/nodes/normalization/aispeech_norm/normalization_impl/` | 完整的文本归一化模块 |
| `src/sure_eval/evaluation/nodes/scoring/wenet_wer/wenet_compute_cer.py` | WER/CER 计算（WeNet 风格） |
