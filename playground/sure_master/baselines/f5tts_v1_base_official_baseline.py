...
def build_batch_infer_command() -> list[str]:
    ...
    command = [
        ...
        "--max-chunk-chars",
        env_str("SURE_TTS_MAX_CHUNK_CHARS", "300"),
        "--min-chunk-chars",
        env_str("SURE_TTS_MIN_CHUNK_CHARS", "40"),
        "--candidate-type",
        "inference",
        "--idea-text",
        DEFAULT_IDEA_TEXT,
    ...
    *,
    ...
    payload = {
        ...
        "inference_config": {
            ...
            "max_chunk_chars": env_str("SURE_TTS_MAX_CHUNK_CHARS", "300"),
            "min_chunk_chars": env_str("SURE_TTS_MIN_CHUNK_CHARS", "40"),
