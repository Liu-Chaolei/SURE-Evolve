...
class ImproveExp(BaseExp):
    """Experiment for applying a specific improvement idea to an existing ASR solution.
    ...
    def run(self, task_description: str, data_preview: str, best_solution: str, idea: str, task_id: str = "exp_001") -> dict:
        ...
        extracts the WER metric, and retries with debug agent on failure (up to 3 times).
        ...
        """
        self.logger.info("Starting improve task execution")
        ...
        try:
            if self.improve_agent:
                ...
                save_code_to_file(self.workspace_path, "run_asr.py", improve_code)
