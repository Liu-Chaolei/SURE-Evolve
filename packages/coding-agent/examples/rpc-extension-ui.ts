...
class InputDialog implements Component {
	...
	constructor(title: string, prefill?: string, secret = false) {
		this.title = title;
		this.dialogInput = new Input({ maskCharacter: secret ? "*" : undefined });
...
async function main() {
	...
	function showInputDialog(
		...
		const dialog = new InputDialog(title, prefill, secret);
