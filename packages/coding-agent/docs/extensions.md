...
Optional: add a concise usage hint and argument auto-completion for `/command ...`:
...
pi.registerCommand("deploy", {
  ...
  // Set hidden: true for compatibility commands that should remain executable
  // without appearing in autocomplete or command listings.
