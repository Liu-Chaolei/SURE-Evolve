...
| SD | `fixtures/tasks/sd/README.md` | Existing SD audio smoke examples plus MeetEval annotation examples |
| SA-ASR | `fixtures/tasks/sa_asr/README.md` | MeetEval annotation examples for speaker-attributed ASR |
