...
| SD | `sd/README.md` | Existing SD audio smoke examples under `tests/fixtures/SD/`; metric annotations should be MeetEval-loadable. |
| SA-ASR | `sa_asr/README.md` | Annotation-file smoke inputs for speaker-attributed ASR; metric annotations should be MeetEval-loadable. |
